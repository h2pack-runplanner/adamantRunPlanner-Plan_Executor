...
function logic.attach(module, data)
    ...
    local inventoryBindings = featureInventory.attach(module, data.session, getState, report, room, route)
    commerceHooks.attach(module, data.session, getState, report, room, inventoryBindings)
    interactionHooks.attach(module, data.session, getState, report, room)
end
